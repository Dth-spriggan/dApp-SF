...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=HYPER_SPRIGGAN\\SQLEXPRESS;Initial Catalog=SilverFlagPC;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False;Command Timeout=30");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A2B3BAB2FF2");
        ...
        {
            entity.HasKey(e => e.TokenId).HasName("PK__NFT_Warr__658FEE8A818CC66C");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAFE43C411D");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30C9AFB27A4");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__B40CC6ED2CD3AC49");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC5DD86FB7");
