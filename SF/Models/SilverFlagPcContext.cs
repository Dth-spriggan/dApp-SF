...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NftWarranty>(entity =>
        {
            ...
            entity.Property(e => e.MetadataUri).HasMaxLength(500);
            entity.Property(e => e.MintStatus).HasMaxLength(50);
            entity.Property(e => e.MintTxHash)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.ChainTokenId)
                .HasMaxLength(100)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(e => e.NftWarrantyEnabled).HasDefaultValue(false);
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.UserId).HasColumnName("UserID");
            entity.Property(e => e.DefaultAddress).HasMaxLength(255);
            entity.Property(e => e.DefaultContactEmail)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.DefaultRecipientName).HasMaxLength(100);
